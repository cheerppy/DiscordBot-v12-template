...
const consolelog = console.log;console.log = (...a) => consolelog(strJst(getJst()), ...a);const consoleerror = console.error;console.error = (...a) => consoleerror(red + strJst(getJst()), ...a, reset);
...
const guilds = src.guilds.guilds;
